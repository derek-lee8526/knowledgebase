...
exports.getOtherUserData = (req, res, next) => {
    ...
    res.render('otherUserProfile', {otherUserProfile: userData, otherUserPosts: userPosts, otherUserLatestPosts: postData, otheruserPostReplies: postReplies, otherUserProfileCSS: true})
}
